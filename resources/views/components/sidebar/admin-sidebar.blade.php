<x-sidebar-dashboard>
    ...
    <x-sidebar-menu-Adminlaporan routeName="practice.fourth" title="Pengguna"/>
    <x-sidebar-menu-Adminpengguna routeName="practice.fifth" title="Laporan"/>
    <x-sidebar-menu-Adminpengaturan routeName="practice.sixth" title="Pengaturan"/>
</x-sidebar-dashboard>
-