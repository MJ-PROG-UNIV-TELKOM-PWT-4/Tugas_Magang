...
@section('content')
    ...
    {{--        STOK BARANG       --}}
    {{-- ======================== --}}
    <div class="flex items-center justify-between px-4 py-4 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 rounded-t-lg shadow-sm">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        <thead class="bg-gray-100 dark:bg-gray-700">
                            <tr>
                                ...
                                <th class="p-4 text-xs font-bold text-left text-gray-500 uppercase dark:text-gray-400">Kategori</th>
                                ...
                                <th class="p-4 text-xs font-bold text-left text-gray-500 uppercase dark:text-gray-400">Sisa</th>
